...
command = "ffmpeg -i - -preset ultrafast -b:a 128k  -map 0:0 -map 0:1 -map 0:0 -map 0:1 -map 0:0 -map 0:1 -s:v:0 " \
          ...
          "libx265 -b:v:1 1500k -var_stream_map 'v:0,a:0 v:1,a:1 v:2,a:2'  -master_pl_name small_video3/master.m3u8  -f hls " \
          "-hls_time 6 -hls_list_size 0 -hls_flags temp_file  small_video3/segement%v/video.m3u8"
